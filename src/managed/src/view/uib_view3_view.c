...
void connection_view3_button1_onclicked(uib_view3_view_context*, Evas_Object*, void*);
void connection_view3_button6_onclicked(uib_view3_view_context*, Evas_Object*, void*);

uib_view_context* uib_view_view3_create(Evas_Object* parent, void* create_callback_param) {
	uib_view3_view_context* vc = calloc(1, sizeof(uib_view3_view_context));
	vc->parent = parent;
	vc->view_name = "view3";
	...
	//bind event handler
	evas_object_smart_callback_add(vc->button1, "clicked", (Evas_Smart_Cb)connection_view3_button1_onclicked, vc);
	evas_object_smart_callback_add(vc->button6, "clicked", (Evas_Smart_Cb)connection_view3_button6_onclicked, vc);
...
void uib_view3_config_HD_portrait() {
	uib_app_manager_st* uib_app_manager = uib_app_manager_get_instance();
	uib_view3_view_context* vc = (uib_view3_view_context*)uib_app_manager->find_view_context("view3");
	if(!vc) {
		return;
	}
	if(vc->grid1) {
