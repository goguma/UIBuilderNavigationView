...
static void (*uib_view4_config_delegate_portrait)();
static void (*uib_view4_config_delegate_landscape)();
...
char* g_view4_config_name_portrait = NULL;
char* g_view4_config_name_landscape = NULL;
...
void uib_views_init() {
	if(!gst_uib_views.is_init) {
		...
		case e_resolution_HD:
			...
			uib_view4_config_delegate_portrait = &uib_view4_config_HD_portrait;
			g_view4_config_name_portrait = "common";
			uib_view4_config_delegate_landscape = &uib_view4_config_HD_portrait;
			g_view4_config_name_landscape = "common";

			break;
		case e_resolution_WVGA:
			uib_view1_config_delegate_portrait = &uib_view1_config_WVGA_portrait;
			g_view1_config_name_portrait = "wvga";
			uib_view1_config_delegate_landscape = &uib_view1_config_HD_portrait;
			g_view1_config_name_landscape = "common";
...
void set_targeted_view(uib_view_context* vc) {
	...
	if(gi_cur_user_view_idx < 0) {
		...
		uib_util_rotation_set(g_win_obj->win, e_rotation_fullSensor);
	} else if(!strcmp(view_name,"view4")) {
			gst_uib_views.uib_view_target_config_portrait = uib_view4_config_delegate_portrait;
			gst_uib_views.uib_view_target_config_landscape = uib_view4_config_delegate_landscape;

			g_views_config_delegate_name_portrait = g_view4_config_name_portrait;
			g_views_config_delegate_name_landscape = g_view4_config_name_landscape;
